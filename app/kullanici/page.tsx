    ...
    return (
      <div className="admin-page-container">
        ...
        <div className="admin-main-content">
          <Header />
          <main className="admin-content-wrapper flex items-center justify-center">
      ...
      <div className="admin-main-content">
        ...
        <div className="admin-content-wrapper">
          ...
          <div className="mb-6 flex justify-between items-center">
            <h1 className="admin-text-lg">Kullanıcılar</h1>
            <button
              onClick={handleSyncUsers}
              disabled={syncing}
              className={`admin-btn flex items-center space-x-1 ${
                syncing 
                  ? 'admin-btn-secondary cursor-not-allowed' 
                  : 'admin-btn-primary'
              }`}
            >
              <RefreshCw className={`h-3 w-3 ${syncing ? 'animate-spin' : ''}`} />
              <span>{syncing ? 'Senkronize Ediliyor...' : 'Ana Siteden Senkronize Et'}</span>
            </button>
          </div>
            ...
            <div className="admin-grid-4">
              <div className="admin-card-small">
                <div className="flex items-center space-x-1">
                  ...
                  <div>
                    <p className="admin-text-xs">Toplam</p>
                    <p className="admin-text-sm">{totalUsers}</p>
                  </div>
                </div>
              </div>
              <div className="admin-card-small">
                <div className="flex items-center space-x-1">
                  ...
                  <div>
                    <p className="admin-text-xs">Aktif</p>
                    <p className="admin-text-sm">{activeUsers}</p>
                  </div>
                </div>
              </div>
              <div className="admin-card-small">
                <div className="flex items-center space-x-1">
                  ...
                  <div>
                    <p className="admin-text-xs">Pasif</p>
                    <p className="admin-text-sm">{inactiveUsers}</p>
                  </div>
                </div>
              </div>
              <div className="admin-card-small">
                <div className="flex items-center space-x-1">
                  ...
                  <div>
                    <p className="admin-text-xs">Son güncelleme</p>
                    <p className="admin-text-sm">{lastUpdate}</p>
                  </div>
                </div>
              </div>
            </div>
